...
#         circle1 = mpl.patches.Star.Circle((xpt, ypt), 6, color=RED, ec=EDGE_GRAY, lw=0.3)
        p.m.scatter(xpt, ypt, marker=(5, 1, 0), s=40, color="m", edgecolors=COLOR_LINE, lw=0.1, zorder=10)
        fnt = p.font
        fnt.set_size(5)
        plt.annotate(location, xy=(xpt, ypt + 2), ha="center", fontproperties=fnt, size=7, color=COLOR_Darkgray)
